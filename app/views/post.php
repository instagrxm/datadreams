...
<head>
    ...
    <?php if ($isTagPeopleActive): ?>
    <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/tag-people/node_modules/taggd/dist/taggd.css?v=".VERSION ?>">
    <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/tag-people/assets/css/bootstrap-modal.css?v=".VERSION ?>">
    <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/tag-people/assets/css/taggd.css?v=".VERSION ?>">
    <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/tag-people/assets/css/styles.css?v=".VERSION ?>">
    <?php endif; ?>
...
<?php if ($isTagPeopleActive): ?>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/node_modules/devbridge-autocomplete/dist/jquery.autocomplete.min.js?v=".VERSION ?>"></script>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/node_modules/js-storage/js.storage.min.js?v=".VERSION ?>"></script>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/node_modules/taggd/dist/taggd.js?v=".VERSION ?>"></script>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/node_modules/bootstrap/dist/js/bootstrap.min.js?v=".VERSION ?>"></script>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/assets/js/jquery.tagpeople.js?v=".VERSION ?>"></script>
<script type="text/javascript" src="<?= PLUGINS_URL."/tag-people/assets/js/core.js?v=".VERSION ?>"></script>
<?php endif; ?>
