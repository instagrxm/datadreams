                            ...
                            <div class="options">
                                ...
                                <div class="option-group none payment-gateways" style="margin-bottom:45px">
                                    ...
                                    <div class="clearfix">
                                        <?php if ($Integrations->get("data.stripe.publishable_key") && $Integrations->get("data.stripe.secret_key")): ?>
                                            <div class="option-group-item">
                                                <label>
                                                    <input class="custom-radio" name="payment-gateway" type="radio"
                                                           value="stripe"
                                                           data-recurring="<?= $Integrations->get("data.stripe.recurring") ? "true" : "false" ?>">
                                                    <div>
                                                        <div class="text-c">
                                                            <img src="<?= APPURL . "/assets/img/cc/visa.svg" ?>"
                                                                 alt="Visa">
                                                            <img src="<?= APPURL . "/assets/img/cc/mastercard.svg" ?>"
                                                                 alt="MasterCard">
                                                        </div>
                                                    </div>
                                                </label>
                                        ...
                                        <?php if ($Integrations->get("data.paypal.client_id") && $Integrations->get("data.paypal.client_secret")): ?>
                                            <div class="option-group-item">
                                                <label>
                                                    <input class="custom-radio" name="payment-gateway" type="radio"
                                                           value="paypal"
                                                           data-recurring="<?= $Integrations->get("data.paypal.recurring") ? "true" : "false" ?>">
                                                    <div>
                                                        <div class="text-c">
                                                            <img src="<?= APPURL . "/assets/img/cc/paypal.svg" ?>"
                                                                 alt="Visa">
                                                        </div>
                                                    </div>
                                                </label>
                                        ...
                                        <?php Event::trigger("renew.add_coupon_checkout"); ?>
                                ...
                                <div class="option-group none payment-cycle">
                                    ...
                                    <div class="clearfix">
                                        <div class="option-group-item">
                                            <label>
                                                <input class="custom-radio" name="payment-cycle" type="radio"
                                                       value="onetime" checked>

                                                <div>
                                                    <div>
                                                        <div class="price fz-26"><?= __("One time") ?></div>
                                                        <div class="fz-12 mt-5"><?= __("This is one time payment") ?>
                                                            <br><br></div>
                                                    </div>
                                                </div>
                                            </label>
                                    ...
                                    <?php Event::trigger("user.invoicer.tax", $AuthUser); ?>

                                <?php Event::trigger("renew.contoller_couponcheckout_three"); ?>
                                <div class="clearfix">
                                    <div class="col s12 m6 l4">

                                        <input class="fluid button button--dark button--oval" type="submit"
                    ...
                    <?php foreach ($Packages->getDataAs("Package") as $p): ?>
                        <div class="package-list-item">
                            <div>
                                    ...
                                    <div class="feature">
                                        ...
                                        <div style="height: 35px;">
                                            ...
                                            <?php if ($p->get("settings.file_pickers.google_drive")): ?>
                                                <?php $none = false; ?>
                                                <span class="icon m-5 mdi mdi-google-drive tippy" title="Google Drive"
                                                      data-size="small"></span>
                                            <?php endif ?>

                                            <?php if ($p->get("settings.file_pickers.dropbox")): ?>
                                                <?php $none = false; ?>
                                                <span class="icon m-5 mdi mdi-dropbox tippy" title="Dropbox"
                                                      data-size="small"></span>
                                            <?php endif ?>

                                            <?php if ($p->get("settings.file_pickers.onedrive")): ?>
                                                <?php $none = false; ?>
                                                <span class="icon m-5 mdi mdi-onedrive tippy" title="OneDrive"
                                                      data-size="small"></span>
                                            <?php endif ?>

                                            <?php if ($none): ?>
                                                <span class="m-5 inline-block"
                                                      style="line-height: 24px;"><?= __("Not available") ?></span>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                ...
                                <div class="choose">
                                    <a href="<?= APPURL . "/renew?package=" . $p->get("id") ?>"
                                       class="button button--dark button--oval"><?= __("Select") ?></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
