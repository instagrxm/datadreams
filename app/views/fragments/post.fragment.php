...
<div class="advanced-settings">
	<div class="mb-10">
		<div class="pos-r">
			...
			<input class="location input leftpad rightpad" 
	...
	<div class="mb-20">
		<div class="pos-r">
			<input class="input leftpad rightpad" 
				...
				type="text" 
				placeholder="<?= __("Link") ?>"
				value="<?= htmlchars($Post->get("link")); ?>">
			<a href="javascript:void(0)" 
				class="js-link-worked tippy mdi mdi-checkbox-marked-circle-outline color-success field-icon--right none" 
				data-size="small"
				title="<?= __("Link is correct") ?>"></a> 
			<a href="javascript:void(0)" 
				data-size="small"
				class="js-link-not-worked tippy mdi mdi-alert-circle color-danger field-icon--right none" 
				title="<?= __("Incorrect link") ?>"></a>
			<span class="sli sli-link field-icon--left pe-none"></span>
		</div>
		<ul class="field-tips">
			<div class="mt-5"> 	
				<li><?= __("You can use story links ONLY if you have a business account with >= 10k followers") ?></li>
			</div>
		</ul>	 
	</div>
</div>
